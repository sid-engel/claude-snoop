...
usage() {
  echo "Usage: $0 --target <IP/subnet> [--title <title>] [--workers N] [--external true|false]"
  echo ""
  echo "Required:"
...
claude "Run a full claude-snoop audit. Target: $TARGET. Report title: $TITLE. Workers: $WORKERS. External scan: $EXTERNAL. Follow the instructions in CLAUDE.md."
